...
-p 8000:8000 -e OPENSEARCH_PASSWORD=$OPENSEARCH_PASSWORD -e OPENSEARCH_USERNAME=$OPENSEARCH_USERNAME -e OPENSEARCH_HOST=$OPENSEARCH_HOST ${AWS_ACCOUNT_ID}.dkr.ecr.${AWS_REGION}.amazonaws.com/facial-recognition-repository:latest
